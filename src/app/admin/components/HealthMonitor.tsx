...
import { fetchDiskUsage, fetchHealth, SystemHealth } from '@/app/admin/actions'
...
export function HealthMonitor() {
  const { data: health, error: healthError } = useSWR<SystemHealth, unknown>('adminHealth', () => fetchHealth(), {
    ...
    return (
      <section>
        ...
        <p style={{ color: '#dc2626' }}>
          Failed to load: {healthError instanceof Error ? healthError.message : 'Unknown error'}
        </p>
      </section>
    )
  }
